...
namespace WebBanHang.Models
{
  public enum ErrorCode : int
  {
    ...
    FILE_UPLOAD_QUANTITY_LIMIT_EXCEED,
    ...
    WAREHOUSE_ITEM_UNEXPECTED_ERROR = 900,
    MANUFACTURER_UNEXPECTED_ERROR = 1000,
    MANUFACTURER_NOT_FOUND_ERROR = 1099,

    BASKET_UNEXPECTED_ERROR = 1100,

    BASKET_NOT_FOUND_ERROR = 1199
  }
}
