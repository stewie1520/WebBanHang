...
namespace WebBanHang.Controllers
{
    ...
    public class BasketsController : ControllerBase
    {
        ...
        [HttpGet("")]
        [Authorize]
        public async Task<IActionResult> GetAllBaskets([FromQuery] PaginationParam pagination, [FromQuery] int type = 0)
        {
            var res = await _service.GetAllBasketsAsync(pagination, type);
